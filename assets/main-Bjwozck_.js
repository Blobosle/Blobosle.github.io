import{r as N,j as M,a as Zc,R as aa,c as Qc}from"./devicon.min-B9QjgrPl.js";function yr(s){if(s===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return s}function il(s,e){s.prototype=Object.create(e.prototype),s.prototype.constructor=s,s.__proto__=e}/*!
 * GSAP 3.13.0
 * https://gsap.com
 *
...
`;function _h({duration:s=1e3,delay:e=0,timingFunction:r="ease",keyframes:t=Uc,iterationCount:n=1}){return Wc`
  ...
  `}function yh(s){return s==null}function vh(s){return typeof s=="string"||typeof s=="number"||typeof s=="boolean"}function qc(s,e){return r=>r?s():e()}function Pi(s){return qc(s,()=>null)}function Oo(s){return Pi(()=>({opacity:0}))(s)}const Gc=s=>{const{cascade:e=!1,damping:r=.5,delay:t=0,duration:n=1e3,fraction:i=0,keyframes:o=Uc,triggerOnce:a=!1,className:l,style:c,childClassName:u,childStyle:h,children:p,onVisibilityChange:f}=s,m=N.useMemo(()=>_h({keyframes:o,duration:n}),[n,o]);return yh(p)?null:vh(p)?Ye(xh,{...s,animationStyles:m,children:String(p)}):nh.isFragment(p)?Ye(Kc,{...s,animationStyles:m}):Ye(Wd,{children:N.Children.map(p,(d,g)=>{if(!N.isValidElement(d))return null;const v=t+(e?g*n*r:0);switch(d.type){case"ol":case"ul":return Ye(Ks,{children:({cx:y})=>Ye(d.type,{...d.props,className:y(l,d.props.className),style:Object.assign({},c,d.props.style),children:Ye(Gc,{...s,children:d.props.children})})});case"li":return Ye(tl,{threshold:i,triggerOnce:a,onChange:f,children:({inView:y,ref:b})=>Ye(Ks,{children:({cx:x})=>Ye(d.type,{...d.props,ref:b,className:x(u,d.props.className),css:Pi(()=>m)(y),style:Object.assign({},h,d.props.style,Oo(!y),{animationDelay:v+"ms"})})})});default:return Ye(tl,{threshold:i,triggerOnce:a,onChange:f,children:({inView:y,ref:b})=>Ye("div",{ref:b,className:l,css:Pi(()=>m)(y),style:Object.assign({},c,Oo(!y),{animationDelay:v+"ms"}),children:Ye(Ks,{children:({cx:x})=>Ye(d.type,{...d.props,className:x(u,d.props.className),style:Object.assign({},h,d.props.style)})})})})}})})},bh={display:"inline-block",whiteSpace:"pre"},xh=s=>{const{animationStyles:e,cascade:r=!1,damping:t=.5,delay:n=0,duration:i=1e3,fraction:o=0,triggerOnce:a=!1,className:l,style:c,children:u,onVisibilityChange:h}=s,{ref:p,inView:f}=Hc({triggerOnce:a,threshold:o,onChange:h});return qc(()=>Ye("div",{ref:p,className:l,style:Object.assign({},c,bh),children:u.split("").map((m,d)=>Ye("span",{css:Pi(()=>e)(f),style:{animationDelay:n+d*i*t+"ms"},children:m},d))}),()=>Ye(Kc,{...s,children:u}))(r)},Kc=s=>{const{animationStyles:e,fraction:r=0,triggerOnce:t=!1,className:n,style:i,children:o,onVisibilityChange:a}=s,{ref:l,inView:c}=Hc({triggerOnce:t,threshold:r,onChange:a});return Ye("div",{ref:l,className:n,css:Pi(()=>e)(c),style:Object.assign({},i,Oo(!c)),children:o})};function wh(s){switch(s){case"bounce":return[ih,{transformOrigin:"center bottom"}];case"flash":return[sh];case"headShake":return[oh,{animationTimingFunction:"ease-in-out"}];case"heartBeat":return[ah,{animationTimingFunction:"ease-in-out"}];case"jello":return[lh,{transformOrigin:"center"}];case"pulse":return[ch,{animationTimingFunction:"ease-in-out"}];case"rubberBand":return[uh];case"shake":return[fh];case"shakeX":return[dh];case"shakeY":return[hh];case"swing":return[ph,{transformOrigin:"top center"}];case"tada":return[gh];case"wobble":return[mh]}}const Sh=s=>{const{effect:e="bounce",style:r,...t}=s,[n,i]=N.useMemo(()=>wh(e),[e]);return Ye(Gc,{keyframes:n,style:Object.assign({},r,i),...t})};E`
  from,
  20%,
  40%,
  60%,
